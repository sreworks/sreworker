...
class TestClaudeCodeWorker:
    ...
    class TestConvertRawMessage:
        """SUT: ClaudeCodeWorker._convert_raw_message"""
        ...
        def test_assistant_tool_result(self):
    ...
    class TestFetchMessages:
        """SUT: ClaudeCodeWorker.fetch_messages"""
        ...
        @pytest.mark.asyncio
        async def test_reads_jsonl(self, tmp_path, monkeypatch):
    ...
    class TestActivateSession:
        """SUT: ClaudeCodeWorker.activate_session"""

        def test_adds_to_active_sessions(self):
            """Should add entry to _active_sessions."""
    ...
    class TestDeactivateSession:
        """SUT: ClaudeCodeWorker.deactivate_session"""

        def test_removes_from_active_sessions(self):
            """Should remove entry from _active_sessions."""
            ClaudeCodeWorker.activate_session("raw1", "conv1", "w1")
            ClaudeCodeWorker.deactivate_session("raw1")
            assert "raw1" not in ClaudeCodeWorker._active_sessions

    class TestStopWatching:
        """SUT: ClaudeCodeWorker.stop_watching"""

        def test_clears_all_state(self):
            """Should clear all class-level state."""
